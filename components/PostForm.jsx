    ...
    return (
        <div className="p-4 bg-white border rounded-lg">
            ...
            <div className='form' >
                ...
                <div className="mt-3">
                    <label for="discription" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Job Description</label>
                ...
                <div className='grid lg:grid-cols-2 xl:grid-cols-3 gap-2'>
                    ...
                    <div className="mt-3">
                        <label for="start_date" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Start Date</label>
                    ...
                    <div className="mt-3">
                        <label for="Last_date" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Last Date</label>
